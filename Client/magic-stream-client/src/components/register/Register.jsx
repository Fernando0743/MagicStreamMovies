...
const Register = () => {
    ...
    //Function to update favouriteGenres array variable everytime user selects a genre from user form
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            //Registration succesful, redirect to User
    ...
    //When Register component loads, we use UseEffect to call the genres endpoint on the server and populate genres list with 
    //genres data from the server
    useEffect(() => {
    ...
    return (
        ...
        <div className='login-card shadow p-4 rounded bg-white' style={{maxWidth: 400, width: '100%'}}>
            <div className='text-center mb-4'>
                ...
                <p className='text-muted'>Create your Magic Movie Stream Server account</p>
            ...
            <Form onSubmit={handleSubmit}>
                ...
                <Form.Group>
                    {/*Creater collection of genres that user can select */}
                    <Form.Select
                        multiple
